    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <div className="relative group">
          ...
          <div className="relative flex items-center gap-2 bg-zinc-900/90 px-4 py-2 rounded-full border border-emerald-500/30 group-hover:border-emerald-500/60 transition-all duration-300 backdrop-blur-sm">
            <span className="text-sm text-white font-mono">
              {/* Show shortened address: 0x1234...5678 */}
